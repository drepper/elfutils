...
static Dwarf_Frame_State *default_frame_state (Ebl *ebl, pid_t pid, bool pid_attach, Elf *core);
...
fill_defaults (Ebl *result)
{
  ...
  result->frame_dwarf_to_regno = NULL;
}
...
default_frame_state (Ebl *ebl __attribute__ ((unused)), pid_t pid __attribute__ ((unused)), bool pid_attach __attribute__ ((unused)), Elf *core __attribute__ ((unused)))
{
  return NULL;
}
